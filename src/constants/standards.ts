...
// 1. 광고 등급 비주얼 표준 (Ad Tier Standards) — 야사장 구독 플랜 기준 (2026-05-04 v2.1)
...
// 2. 급여 배지 약어 및 컬러 표준 (Pay Badge Standards v2.1 — 2026-05-04)
// ⚠️ PROTECTED: 아래 색상은 대표님 확정 규칙. 임의 변경 금지.
// v2.1: abbr를 단일 문자에서 풀네임(2자)로 변경 — 가독성 강화 (대표님 승인)
