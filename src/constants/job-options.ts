export const PAY_SUFFIX_OPTIONS = [
    '보도', '고정아가씨', '+α', '보너스', '팁별도', '엔터프라이즈', '고액알바',
    ...
    '숙식제공', '식사제공', '교통비지원', '인센티브', '인플루언서', '남자실장', '인재실장'
];

export const CONVENIENCE_KEYWORDS = [
    '초보가능', '당일지급', '당일알바', '평일알바', '주말알바', '주간알바', '초이스없음', '20대알바', '30대알바', '40대알바',
    '엔터프라이즈 인재 솔루션', '엔터프라이즈 인재 솔루션', '투잡알바', '야간알바', '단기알바', '경력우대', '파트타임', '여성알바', '인재알바',
    '모델알바', '프라이빗 매칭', '보도알바', '엔터프라이즈', '고액알바'
];
