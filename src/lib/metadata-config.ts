...
const CLEAN_SEO: SEOConfig = {
  ...
  metadata: {
    ...
    description: "코코알바는 유흥룸알바, 룸알바, 노래빠알바, 여자유흥알바, 여자노래빠알바, 여자노래방알바 구인정보 1위 플랫폼입니다. 검증된 업체, 당일지급 100% 보장.",
    keywords: ["룸알바", "유흥룸알바", "노래빠알바", "노래방알바", "유흥알바", "여자유흥알바", "여자노래빠알바", "여자노래방알바", "BJ알바", "엔터알바", "여성알바", "밤알바", "고수익알바", "당일지급알바"],
    verification: {
