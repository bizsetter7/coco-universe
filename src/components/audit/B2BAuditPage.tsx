      ...
      <section className="bg-[#fcfdfe] pt-20 pb-24 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-3/5 text-left">
            ...
            <p className="text-lg sm:text-xl text-gray-500 max-w-lg mb-10 font-medium leading-relaxed">코코알바는 검증된 파트너사와 실력 있는 인재를 실시간으로 자동 매칭하고 안전한 정산 시스템을 제공하는 B2B 통합 솔루션입니다.</p>
                ...
                <div className="space-y-6">
                  <div className="h-64 bg-gray-50 rounded-2xl p-6 overflow-y-auto text-sm text-gray-500 font-bold leading-relaxed scrollbar-hide border border-gray-100">
                    {modalTitle.includes('이용약관') && (
                      <div className="space-y-4">
                        <p>[제 1 조 목적]</p>
                        <p>본 약관은 초코아이디어(이하 '회사')가 운영하는 코코알바 B2B 솔루션 및 관련 제반 서비스의 이용 조건 및 절차를 규정함을 목적으로 합니다.</p>
                        <p>[제 2 조 서비스의 제공]</p>
