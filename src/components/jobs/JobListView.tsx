                            ...
                            shops.slice(0, visibleCount).map((shop, i) => {
                                ...
                                return (
                                    <React.Fragment key={shop.id || i}>
                                        <div
                                            onClick={() => setSelectedShop(shop)}
                                            className={`p-4 active:bg-gray-50 transition-colors flex justify-between items-start gap-3 job-mobile-item ${brand.theme === 'dark' ? 'bg-gray-900 active:bg-gray-800' : 'bg-white'}`}
                                        >
