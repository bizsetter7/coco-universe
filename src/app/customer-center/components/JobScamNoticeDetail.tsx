    ...
    return (
        <div className="flex flex-col py-6 md:py-10 max-w-4xl mx-auto space-y-8 font-sans">
            <div className="text-center space-y-3">
                ...
                <h4 className="text-2xl md:text-3xl font-black tracking-tighter text-gray-900 break-keep">취업사기 주의</h4>
                <div className="inline-block px-4 py-1.5 rounded-full bg-red-50 text-red-600 text-sm font-bold">필독 공지</div>
            </div>
            <div className="bg-white rounded-3xl border border-gray-100 p-6 md:p-10 shadow-sm space-y-8 text-gray-700">
                    ...
                    <div className="bg-gray-50 rounded-2xl p-5 space-y-3">
                        {[
                            ...
                            <div key={label} className="flex items-center gap-3 text-sm">
                                <span className="font-black min-w-[110px]" style={{ color: HOT_PINK }}>{label}</span>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-sm text-gray-600">
                        <p className="flex gap-2"><span className="shrink-0">•</span><span>(온라인) 보이스피싱 지킴이:&nbsp;<a href="https://www.fss.or.kr" target="_blank" rel="noopener noreferrer" className="underline hover:text-gray-900">www.fss.or.kr</a></span></p>
                        <p className="flex gap-2"><span className="shrink-0">•</span><span>(온라인) 거짓구인광고 신고:&nbsp;<a href="https://www.work24.go.kr" target="_blank" rel="noopener noreferrer" className="underline hover:text-gray-900">www.work24.go.kr</a></span></p>
                        <p className="flex gap-2"><span className="shrink-0">•</span><span>(모바일) 고용24 모바일 앱 &gt; 기타민원 &gt; 거짓구인광고 신고</span></p>
                    </div>
                </section>
            </div>
            <div className="py-5 px-6 rounded-2xl flex flex-col items-center justify-center text-white shadow-lg" style={{ backgroundColor: HOT_PINK }}>
                <div className="flex items-center gap-2 mb-1">
                    <Phone size={20} fill="white" />
                    <span className="text-lg md:text-xl font-black">코코알바 고객센터 1877-1442</span>
                </div>
                <p className="text-[9px] opacity-70 uppercase tracking-widest font-bold">Copyright(c) 2026 COCOALBA All Rights Reserved.</p>
            </div>
        </div>
    );
};
