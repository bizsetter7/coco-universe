    ...
    return (
        <div className="space-y-10">
            ...
            <section id="terms" className="scroll-mt-32">
                ...
                <div className={boxClass}>
                    <div>
                        ...
                        <p className={bodyClass}>본 약관은 초코아이디어(이하 &quot;회사&quot;)가 운영하는 코코알바(cocoalba.co.kr) 온라인 구인구직 플랫폼 및 관련 부가 서비스의 이용 조건과 절차, 회사와 회원 간의 권리·의무 및 책임 사항을 규정함을 목적으로 합니다.</p>
                    </div>
                    <div>
            ...
            <section id="privacy" className="scroll-mt-32">
                ...
                <div className={boxClass}>
                    <p className="text-gray-500 italic">&quot;코코알바&quot;는 「개인정보 보호법」 및 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」에 따라 회원의 개인정보를 보호하고 이와 관련한 고충을 신속하게 처리하기 위해 아래와 같이 개인정보처리방침을 수립·공개합니다.</p>
                    <div>
            ...
            <section id="youth" className="scroll-mt-32">
                ...
                <div className={boxClass}>
                    <p className="text-gray-500">코코알바는 청소년이 건전한 환경에서 성장할 수 있도록 「청소년 보호법」 및 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」에 따라 청소년 보호를 위한 정책을 수립하여 운영합니다.</p>
                    <div>
