        ...
        <div className="flex flex-col items-center py-6 md:py-10 px-1 md:px-0 max-w-4xl mx-auto space-y-8 md:space-y-10">
            ...
            <div className="text-center space-y-3">
                ...
                <h4 className="text-[22px] md:text-4xl font-black text-gray-900 tracking-tighter break-keep leading-tight">
                    사장님 주목! 🙌<br />
                    코코알바가<br className="md:hidden" /> <span className="text-[#f82b60]">통큰 혜택</span>을 쏩니다!
                </h4>
            </div>
            ...
            <div className="w-full text-center space-y-6">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8">
                    ...
                    <a 
                        href="https://t.me/cocoalba_cs_bot" 
                        target="_blank" 
                    ...
                    >
                        ...
                        <span>텔레그램: <span className="text-gray-900 font-black decoration-blue-200 underline underline-offset-4 group-hover:text-blue-500">@cocoalba_cs_bot</span></span>
                    </a>
                </div>
