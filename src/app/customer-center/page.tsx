...
function CustomerCenterContent() {
    ...
    return (
        <>
            ...
            <div className="fixed top-0 left-0 right-0 z-[9999] w-full" style={{ opacity: 1, visibility: 'visible', overflow: 'visible', display: 'flex' }}>
                <div className={`w-full max-w-[1280px] mx-auto h-[56px] flex items-center justify-between px-4 border-b border-x shadow-sm pointer-events-auto md:backdrop-blur-md ${brand.theme === 'dark' ? 'bg-gray-800 border-gray-700 md:bg-gray-800/95' : 'bg-white border-gray-100 md:bg-white/95'}`} style={{ zIndex: 9999, opacity: 1, visibility: 'visible', overflow: 'visible', display: 'flex' }}>
