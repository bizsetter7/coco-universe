            ...
            */}
                    ...
                    {activeTab === '프리미엄 라운지' ? (
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <Link href="/lounge" className="p-6 rounded-3xl bg-white border border-gray-100 shadow-sm hover:scale-[1.02] transition-all group">
                                    ...
                                    <h4 className="font-black text-lg mb-2 text-gray-900">식단 & BMI 관리</h4>
                                    <p className="text-xs text-gray-600 leading-relaxed mb-4 font-bold">나의 체형분석과 맞춤형 식단 정보를 무료로 받아보세요.</p>
                                ...
                                <Link href="/lounge" className="p-6 rounded-3xl bg-white border border-gray-100 shadow-sm hover:scale-[1.02] transition-all group">
                                    ...
                                    <h4 className="font-black text-lg mb-2 text-gray-900">오늘의 사주 & 운세</h4>
                                    <p className="text-xs text-gray-600 leading-relaxed mb-4 font-bold">재물운, 연애운, 건강운까지 {brand.name}에서 확인하세요.</p>
                                ...
                                <Link href="/lounge" className="p-6 rounded-3xl bg-white border border-gray-100 shadow-sm hover:scale-[1.02] transition-all group">
                                    ...
                                    <h4 className="font-black text-lg mb-2 text-gray-900">성향 & 컬러 테스트</h4>
                                    <p className="text-xs text-gray-600 leading-relaxed mb-4 font-bold">나에게 맞는 메이크업과 최적의 직종을 찾아드립니다.</p>
            ...
            {loginModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
                    ...
                    <div className="bg-white rounded-[45px] w-full max-w-sm p-12 relative z-10 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.3)] border border-white/20">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <h3 className="text-2xl font-black text-gray-900 mb-4 tracking-tight">그녀들만의 비밀 커뮤니티 🤫</h3>
                            <p className="text-gray-700 mb-12 leading-relaxed font-bold text-sm">
                                ...
                                <br />
                                <span className="bg-gray-100 px-4 py-2 rounded-2xl text-gray-900 border border-gray-200">로그인하고 실시간 핫이슈를 확인하세요! 🔥</span>
                            </p>
                            <div className="grid grid-cols-1 w-full gap-3">
                                ...
                                <button
                                    ...
                                    className="w-full py-4 text-gray-500 font-black hover:text-gray-900 transition-colors"
                                >
                                    다음에 할게요
                                </button>
                            </div>
            ...
            {isCorporateModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
                    ...
                    <div className="bg-white rounded-[40px] w-full max-w-xs p-10 relative z-10 shadow-2xl">
                        <div className="flex flex-col items-center text-center">
                            <div className="w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center mb-6 text-blue-600 shadow-inner">
                                <AlertCircle size={32} />
                            </div>
                            <h3 className="text-xl font-black text-gray-900 mb-3 underline decoration-blue-200 decoration-4 underline-offset-4">접근 권한 제한</h3>
                            <p className="text-sm text-gray-800 mb-8 leading-relaxed font-bold">
                                사장님 회원은 구직자들의 소통 공간을<br />
                                열람하실 수 없습니다. 🙏
                            </p>
                            <button
                                onClick={() => setIsCorporateModalOpen(false)}
                                className="w-full py-4 bg-gray-900 text-white rounded-2xl font-black hover:bg-black transition-all outline-none"
                            >
                                확인했습니다
                            </button>
                        </div>
