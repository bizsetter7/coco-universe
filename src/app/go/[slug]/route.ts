 ...
 *
 * 사용법: cocoalba.kr/go/gangnam-room → /coco/서울-강남구/룸알바
 */
...
export async function GET(
    ...
    if (!target) {
        // 매핑 없으면 메인 페이지로
        return NextResponse.redirect(new URL('/', 'https://www.cocoalba.kr'), 302);
    }

    return NextResponse.redirect(
        new URL(target, 'https://www.cocoalba.kr'),
