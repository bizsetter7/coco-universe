...
export const DETAILED_PRICING = [
    { id: 'p1', tier: '그랜드', eng: '(Grand)', name: '그랜드', color: 'text-purple-600', desc: '메인 최상단 노출 및\n압도적 광고 효과', d30: 350000, d60: 630000, d90: 840000, isMain: true },
    { id: 'p2', tier: '프리미엄', eng: '(Premium)', name: '프리미엄', color: 'text-pink-600', desc: '상단 시선 집중\n높은 효율성 노출', d30: 200000, d60: 360000, d90: 480000, isMain: true },
    { id: 'p3', tier: '디럭스', eng: '(Deluxe)', name: '디럭스', color: 'text-blue-600', desc: '타겟 지역 집중\n전략적 배너 노출', d30: 180000, d60: 324000, d90: 432000, isMain: true },
    { id: 'p4', tier: '스페셜', eng: '(Special)', name: '스페셜', color: 'text-teal-600', desc: '가성비 최우선\n실속형 배너 노출', d30: 150000, d60: 270000, d90: 360000, isMain: true },
    { id: 'p5', tier: '급구/추천', eng: '(Urgent/Rec)', name: '급구/추천', color: 'text-orange-600', desc: '급구/추천 배지\n노출로, 주목도\n실속형 광고', d30: 120000, d60: 216000, d90: 288000, isMain: true },
    { id: 'p6', tier: '네이티브', eng: '(Native)', name: '네이티브', color: 'text-gray-600', desc: '리스트 광고에\n배치, 랜덤\n상단노출효과', d30: 100000, d60: 180000, d90: 240000, isMain: true },
    { id: 'p7', tier: '베이직', eng: '(Basic)', name: '베이직', color: 'text-gray-400', desc: '최신 구인정보 리스트\n(실속형 구인 상품)', d30: 60000, d60: 100000, d90: 140000, isMain: true },
    { id: 'bold', tier: '굵은글씨', eng: '', name: '굵은글씨 적용', color: 'text-black', desc: '제목을 굵게 표시하여 관심을 끕니다.', d30: 30000, d60: 55000, d90: 70000, isMain: false },
];
