...
export const PAY_SUFFIX_OPTIONS = [
    '보도', '고정아가씨', '+α', '보너스', '팁별도', '엔터프라이즈', '고액알바', '갯수보장', '만근비지원', '출퇴근지원',
    '고정구함', '초보가능', '선불가능', '급전가능', '성형지원', '따당가능', '순번확실', '푸쉬가능', '대학생알바', '지명우대',
    '친구동반우대', '가족같은분위기', '밀방없음', '뒷방없음', '칼퇴보장', '텃세없음', '당일지급', '면접비지원', '회식활발',
    '출퇴근자유', '홀복지원', '해외여행지원', 'BJ알바', '숙식제공', '식사제공', '교통비지원', '인센티브', '인플루언서', '남자실장', '인재실장'
];

export const STEP4_CONVENIENCE_KEYWORDS = [
    '초보가능', '당일지급', '당일알바', '평일알바', '주말알바', '주간알바', '초이스없음', '20대알바', '30대알바', '40대알바',
    '엔터프라이즈 인재 솔루션', '엔터프라이즈 인재 솔루션', '투잡알바', '야간알바', '단기알바', '경력우대', '파트타임', '여성알바', '인재알바', '모델알바',
    '프라이빗 매칭', '보도알바', '엔터프라이즈', '고액알바'
];
...
export const DETAILED_PRICING = [
    ...
    { id: 'p5', altId: 'recommended', code: 'T5', tier: '급구/추천', eng: '(Urgent/Rec)', name: '타입5. 급구/추천 (Urgent)', color: 'text-orange-600', desc: '급구/추천 배지 노출로\n주목도 실속형', d30: 120000, d60: 216000, d90: 288000, isMain: true },
...
export const FORBIDDEN_WORDS = [
    ...
    '도우미', '전문 인재', '엔터프라이즈 인재 솔루션', '엔터프라이즈 인재 솔루션'
];
