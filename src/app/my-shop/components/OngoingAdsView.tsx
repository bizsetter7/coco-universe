                    ...
                    {ads.length === 0 ? (
                        ...
                        <div className="space-y-6">
                            {ads.map((ad: any) => {
                                ...
                                return (
                                    <div key={ad.id} className="!bg-white border border-gray-200 rounded-2xl overflow-hidden relative shadow-sm transition hover:shadow-md" style={{ backgroundColor: '#ffffff', mixBlendMode: 'normal' }}>
                                        {isPremiumCore && (
                                        ...
                                        <div className="p-4 md:p-6">
                                            <div className="flex flex-col md:flex-row justify-between gap-4">
                                                <div className="space-y-2.5 flex-1">
                                                    ...
                                                    <div className="flex flex-wrap items-center gap-3 text-[11px] font-black">
                                                        ...
                                                        <div className="flex items-center gap-x-3 text-gray-400 font-bold">
                                                    ...
                                                    <h4
                                                        ...
                                                        className={`font-black text-[16px] md:text-[17px] line-clamp-1 cursor-pointer hover:text-pink-500 transition !text-gray-900 force-dark-text leading-tight`}
                                                    >
                                                        {ad.title}
                                                    </h4>
                                                ...
                                                {/* Action Buttons */}
                                                <div className="flex flex-wrap gap-1.5 shrink-0 items-center justify-start md:justify-end">
                                                    <button
                                                        onClick={() => onEditAd?.(ad)}
                                            ...
                                            <div className={`px-5 py-3 flex flex-wrap items-center justify-between gap-3 mt-4 -mx-4 md:-mx-6 border-t ${brand.theme === 'dark' ? 'bg-gray-800/30 border-gray-800' : 'bg-gray-50 border-gray-100'}`}>
                                                <button
