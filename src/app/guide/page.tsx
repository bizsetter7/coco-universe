        ...
        <div className="min-h-screen bg-white flex flex-col font-sans">
            <main className="flex-1 max-w-6xl mx-auto px-4 md:px-8 py-10 md:py-16">
                <div className="text-center mb-10 md:mb-14">
                    <span className="inline-block px-4 py-1.5 bg-pink-50 text-pink-600 rounded-full text-[10px] md:text-xs font-black uppercase tracking-[0.2em] mb-4">
                        STEP BY STEP GUIDE
                    </span>
                    <h1 className="text-3xl md:text-4xl font-black text-slate-900 mb-6 tracking-tighter leading-[1.1]">
                        코코알바 서비스<br className="md:hidden" /> 이용 가이드
                    </h1>
                    <p className="text-slate-500 text-sm md:text-lg font-bold tracking-tight break-keep opacity-80">
                        코코알바를 200% 활용하여 가장 빠르고<br className="md:hidden" /> 안전하게 인재를 찾아보세요.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-6 max-w-5xl mx-auto">
                    ...
                    <div className="relative group bg-white rounded-[28px] p-7 border-2 border-amber-400 shadow-[0_10px_30px_-15px_rgba(251,191,36,0.12)] transition-all hover:-translate-y-1">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="text-slate-600 text-xs md:text-sm leading-relaxed break-keep font-bold opacity-90">
                                사장님이라면 누구나<br /> <strong className="text-pink-600">첫 1개월간 기본 노출 광고를 무료</strong>로 게재할 수 있습니다.
                    ...
                    <div className="relative group bg-pink-50/10 rounded-[28px] p-7 border-2 border-dashed border-pink-200 shadow-[0_10px_30px_-15px_rgba(244,114,182,0.08)] transition-all hover:-translate-y-1">
                        <div className="flex flex-col items-center text-center">
                            <span className="text-[10px] md:text-[11px] font-[900] text-pink-500 uppercase tracking-[0.1em] mb-4">Community / List Native</span>
                            <div className="w-14 h-14 bg-white rounded-full flex items-center justify-center text-pink-500 mb-5 shadow-lg shadow-pink-500/5 ring-4 ring-pink-50">
                            ...
                            <div className="text-slate-600 text-xs md:text-sm leading-relaxed break-keep font-bold opacity-90">
                                ...
                                <div className="mt-4">
                                    <span className="text-[9px] text-pink-600 font-black uppercase tracking-widest bg-pink-100/50 py-1.5 px-3 rounded-full inline-block">Recommended Ad System</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="mt-20 md:mt-28 text-center flex flex-col items-center">
                    ...
                    <Link href="/my-shop?view=form&new=true" className="group flex items-center gap-3 bg-pink-600 hover:bg-pink-500 text-white font-black px-10 md:px-14 py-4 md:py-5 rounded-full text-lg md:text-xl transition-all hover:-translate-y-1 active:scale-95 shadow-xl shadow-pink-500/20">
