    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-gradient-to-b from-[#f82b60]/5 to-transparent py-12 border-b border-gray-100">
                <div className="max-w-5xl mx-auto px-6 text-center">
                    <h1 className="text-3xl font-black text-gray-900 mb-4 tracking-tight">
                        전국 지역별 <span className="text-[#f82b60]">고소득 여성알바</span> 통합 인덱스
                    </h1>
                    <p className="text-gray-500 text-sm leading-relaxed max-w-2xl mx-auto">
                        서울 강남부터 제주까지, 코코알바가 보증하는 프리미엄 업소 정보를 지역별로 한눈에 확인하세요.<br />
                        실시간 업데이트되는 전국 3,218개 지역의 채용 공고를 연결합니다.
                    </p>
                </div>
            </div>
                    ...
                    return (
                        <section key={province} id={`section-${province}`} className="mb-20 scroll-mt-28">
                            <div className="flex items-center gap-4 mb-8">
                                ...
                                <span className="text-xs font-bold text-gray-400">Total {regions.length} regions</span>
                            </div>
            ...
            <div className="sr-only" aria-hidden="true">
                <h2>고소득 여성알바 전국 맛집 정보</h2>
                <p>
                    노래방알바, 룸알바, 가라오케, 당일지급, 고수익 보장. 강남구 인계동 부천 상동 등 전국 주요 상권 100% 매칭.
