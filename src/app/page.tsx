...
export default function HomePortal() {
  ...
  return (
    <div className={`w-full max-w-full min-h-screen relative pb-20 overflow-x-hidden ${brand.theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-white text-black'}`}>
      {/* Header */}
      ...
      <main className="w-full">
        ...
        {currentPage === 'home' && (
          <div className="page-home">
            ...
            <div className="max-w-[1020px] mx-auto px-3 py-6 sm:py-8">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex gap-2">
                  {grandPremiumShops.length > 8 && (
                    <button
                      onClick={() => setGrandLimitHome(prev => prev + 8)}
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                {grandPremiumShops.slice(0, grandLimitHome).map((shop, i) => {
              ...
              {grandPremiumShops.length > grandLimitHome && (
                <button
                  onClick={() => setGrandLimitHome(prev => prev + 8)}
                  className={`w-full mb-6 py-3 rounded-xl border border-dashed transition-all font-bold text-xs ${brand.theme === 'dark' ? 'border-gray-700 text-gray-500 hover:bg-gray-800' : 'border-gray-200 text-gray-400 hover:bg-gray-50'} `}
                >
                  그랜드/프리미엄 광고 더보기 +
                </button>
              )}
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex gap-2">
                    {deluxeShops.length > 8 && (
                      <button
                        onClick={() => setDeluxeLimitHome(prev => prev + 8)}
                        className={`text-[10px] sm:text-[11px] font-black border px-3 py-1.5 rounded-md shadow-md hover:shadow-lg transition-all flex items-center gap-1 active:scale-95 ${brand.theme === 'dark' ? 'bg-gray-800 border-gray-700 text-white' : 'bg-white border-gray-200 text-black'} `}
                      >
                        더보기 +
                      </button>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                  {deluxeShops.slice(0, deluxeLimitHome).map((shop, i) => {
                ...
                {deluxeShops.length > deluxeLimitHome && (
                  <button
                    onClick={() => setDeluxeLimitHome(prev => prev + 8)}
                    className={`w-full mb-0 py-3 rounded-xl border border-dashed transition-all font-bold text-xs ${brand.theme === 'dark' ? 'border-gray-700 text-gray-500 hover:bg-gray-800' : 'border-gray-200 text-gray-400 hover:bg-gray-50'} `}
                  >
                    디럭스 채용공고 더보기 +
                  </button>
                )}
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex gap-2">
                    {specialShops.length > 8 && (
                      <button
                        onClick={() => setSpecialLimitHome(prev => prev + 8)}
                        className={`text-[10px] sm:text-[11px] font-black border px-3 py-1.5 rounded-md shadow-md hover:shadow-lg transition-all flex items-center gap-1 active:scale-95 ${brand.theme === 'dark' ? 'bg-gray-800 border-gray-700 text-white' : 'bg-white border-gray-200 text-black'} `}
                      >
                        더보기 +
                      </button>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                  {specialShops.slice(0, specialLimitHome).map((shop, i) => {
                ...
                {specialShops.length > specialLimitHome && (
                  <button
                    onClick={() => setSpecialLimitHome(prev => prev + 8)}
                    className={`w-full mb-0 py-3 rounded-xl border border-dashed transition-all font-bold text-xs ${brand.theme === 'dark' ? 'border-gray-700 text-gray-500 hover:bg-gray-800' : 'border-gray-200 text-gray-400 hover:bg-gray-50'} `}
                  >
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex gap-2">
                    {urgentRecShops.length > 8 && (
                      <button
                        onClick={() => setUrgentLimitHome(prev => prev + 8)}
                        className={`text-[10px] sm:text-[11px] font-black border px-3 py-1.5 rounded-md shadow-md hover:shadow-lg transition-all flex items-center gap-1 active:scale-95 ${brand.theme === 'dark' ? 'bg-gray-800 border-gray-700 text-white' : 'bg-white border-gray-200 text-black'} `}
                      >
                        더보기 +
                      </button>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                  {urgentRecShops.slice(0, urgentLimitHome).map((shop, i) => {
                ...
                {urgentRecShops.length > urgentLimitHome && (
                  <button
                    onClick={() => setUrgentLimitHome(prev => prev + 8)}
                    className={`w-full mb-0 py-3 rounded-xl border border-dashed transition-all font-bold text-xs ${brand.theme === 'dark' ? 'border-gray-700 text-gray-500 hover:bg-gray-800' : 'border-gray-200 text-gray-400 hover:bg-gray-50'} `}
                  >
              ...
              <div id="job-list-section" className="mt-1">
                <div className="flex items-center justify-between mb-5 w-full">
                  ...
                  <div className="flex items-center gap-2">
                    <Link href="/favorites" className="flex items-center gap-1.5 text-xs font-bold text-amber-500 hover:underline mr-1">
                          ...
                          filteredShops.slice(0, visibleCount).map((shop, i) => {
                            ...
                            return (
                              <React.Fragment key={shop.id || i}>
                                ...
                                {(i + 1) % 3 === 0 && i !== filteredShops.length - 1 && (
                                  <tr>
                                    <td colSpan={6} className="p-2">
                                      <div className="p-4 rounded-xl border-2 border-dashed border-pink-300 bg-pink-50/50 flex items-center justify-between">
                                        ...
                                        <button
                                          onClick={(e) => { e.stopPropagation(); setCurrentPage('payment'); }}
            ...
            {/* Shop Detail Modal moved to global scope */}
          </div>
        )
        }
        ...
        {
          currentPage === 'region' && (
            <div className="w-full max-w-[1020px] mx-auto py-0 md:py-8 min-h-screen bg-gray-50 md:bg-white overflow-x-hidden px-0 md:px-4">
                ...
                <div className="flex-1 px-4 pt-6 pb-0 md:px-0">
                  ...
                  {grandPremiumShops.length > grandLimit && (
                    <button
                      ...
                      className={`w-full mb-8 py-3 rounded-xl border border-dashed transition-all font-bold text-xs ${brand.theme === 'dark' ? 'border-gray-700 text-gray-500 hover:bg-gray-800' : 'border-gray-200 text-gray-400 hover:bg-gray-50'} `}
                    >
                      그랜드/프리미엄 광고 더보기 +
                    </button>
                  )}
